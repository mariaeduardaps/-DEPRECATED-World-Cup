...
match_predictions <- read.csv(paste0(path,'semi_final_match_predictions_2018.csv'))
...
write.csv(df_matches_final,paste0(path,'final_matches_2018.csv'),row.names = FALSE)
write.csv(df_matches_third,paste0(path,'third_place_matches_2018.csv'),row.names = FALSE)
