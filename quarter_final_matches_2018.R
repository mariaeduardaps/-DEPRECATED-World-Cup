...
match_predictions <- read.csv(paste0(path,'round_16_match_predictions_2018.csv'))
...
write.csv(df_matches_quarter,paste0(path,'quarter_matches_2018.csv'),row.names = FALSE)