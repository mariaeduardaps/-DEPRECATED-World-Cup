...
countries_on_round_16 <- read.csv(paste0(path,'classification_round_16_2018.csv'))
...
write.csv(df_matches_final,paste0(path,'matches_round_of_16_2018.csv'),row.names = FALSE)
