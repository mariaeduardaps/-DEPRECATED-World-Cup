...
quarter_matches <- read.csv(paste0(path,'quarter_matches_2018.csv'))
...
write.csv(df_clean_quarter_finals,paste0(path,'df_test_quarter_finals_2018.csv'),row.names = FALSE) 