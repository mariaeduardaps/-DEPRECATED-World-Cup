...
match_predictions <- read.csv(paste0(path,'quarter_final_match_predictions_2018.csv'))
...
write.csv(df_matches_semi,paste0(path,'matches_semi_2018.csv'),row.names = FALSE)